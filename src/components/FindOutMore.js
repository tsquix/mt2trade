...
export default function FindOutMore({ halfSection }) {
  ...
  return (
    ...
    >
      <div className="p-4 xl:grid xl:grid-cols-[0.5fr_1.5fr] gap-24 ">
        <div
          className={`font-normal sticky top-24 z-0 mb-24 md:mb-12 ${halfSection ? 'block12' : 'hidden12'}`}
        >
          ...
          <p className="text-3xl lg:text-5xl">consectetur adipisicing elit.</p>
